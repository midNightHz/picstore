package cn.midnight.base.service;
...
import cn.midnight.base.constants.RepetitionStrategy;
import cn.midnight.base.controller.CallContext;
import cn.midnight.base.entity.BaseEntity;
import cn.midnight.base.model.ExcelImportFailData;
import cn.midnight.base.model.ExcelImportResultModel;
import cn.midnight.utils.ExcelUtil;
...
public interface IExcelImportService<T extends BaseEntity<ID>, ID extends Serializable> extends BaseService<T, ID> {
     ...
     * 
     * @Title: toEntity   
     * @Description: excel列表转换为对象  
     * @author:陈军
     * @date 2019年1月21日 上午9:53:08 
     * @param datas
     * @return
     * @throws Exception      
     * List<T>      
    ...
    /**
     * 
     * @Title: repetitionStrategy   
     * @Description:重复策略  
     * @author:陈军
     * @date 2019年1月21日 上午10:01:37 
     * @return      
     * RepetitionStrategy      
     * @throws
     */
     ...
     * 
     * @Title: importDatas   
     * @Description: 导入的主要业务逻辑
     * @author:陈军
     * @date 2019年1月21日 上午10:19:08 
     * @param file
     * @param callContext
     * @return
     * @throws Exception      
     * ExcelImportResultModel<T>      
     * @throws
     */
     ...
     * 
     * @Title: importDatas   
     * @Description: 导入的业务逻辑，以流的方式导入  
     * @author:陈军
     * @date 2019年1月21日 上午10:56:28 
     * @param is
     * @param callContext
     * @return
     * @throws Exception      
    ...
    default ExcelImportResultModel<T> importDatas(InputStream is, CallContext callContext)
        ...
        for (int i = 0; i < objs.size(); i++) {
            ...
            if (origin != null) {
                ...
                case cover:
                    try {
                        if (!checkModifyAuth(t, callContext)) {
                            result.addFail();
     ...
     * 
     * @Title: getFieldNames   
     * @Description: 获取读取文件列和实体类中字段的对应关系  
     * @author:陈军
     * @date 2019年1月21日 上午10:46:31 
     * @return
     * @throws Exception      
     * List<String>      
     * @throws
     ...
     * 
     * @Title: startIndex   
     * @Description: 开始读取记录的行 
     * @author:陈军
     * @date 2019年1月21日 上午10:48:23 
     * @return      
     * int      
     * @throws
     */
     ...
     * 
     * @Title: sheet   
     * @Description: 读取指定的 sheet
     * @author:陈军
     * @date 2019年1月21日 上午11:32:02 
     * @return      
     * int      
     * @throws
     */
     ...
     * 
     * @Title: objReplation   
     * @Description: 对象是否重复，不重复则返回空，如果重复则从数据库查询对象  
     * @author:陈军
     * @date 2019年1月21日 下午4:07:29 
     * @param t
     * @return      
     * T      
     * @throws
