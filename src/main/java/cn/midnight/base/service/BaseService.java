...
import cn.midnight.base.model.BaseModel;
import cn.midnight.base.repository.BaseJpaRepository;
import cn.midnight.page.PageData;
import cn.midnight.page.PageDataImpl;
...
public interface BaseService<T extends BaseEntity<ID>, ID extends Serializable> {
	...
	default Boolean exist(T t) throws Exception {
		...
		return getJpaRepository().getOne(t.getId()) != null;
	}
	...
	default Boolean exist(ID id) throws Exception {
		return getJpaRepository().getOne(id) != null;
	}
	...
	default List<T> insertBatch(List<T> list, CallContext callContext) throws Exception {
		...
		return getJpaRepository().saveAll(list);
	}
